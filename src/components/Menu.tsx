            ...
            <Row >
                <Col span={6}>
                    <Row style={{ lineHeight: "1.5" }}>
                        <Col span={8} style={{ margin: "auto 0", fontSize: "20px" }}><HomeOutlined /></Col>
                ...
                <Col span={6}>
                    <Row style={{ lineHeight: "1.5" }}>
                        <Col span={8} style={{ margin: "auto 0", fontSize: "20px" }}><CarOutlined /> </Col>
                ...
                <Col span={6} style={{margin:"auto"}}>
                    <Link to={'/cart'} style={{ color: "#fff" }}>
                        <Row style={{ lineHeight: "1.5" }}>
                            <Col span={8} style={{ margin: "auto 0", fontSize: "20px", display: "flex" }}><ShoppingCartOutlined /> <span style={{ fontSize: "13px", marginTop: "auto" }}>{totalItems} </span></Col>
                ...
                <Col span={6} style={{margin:"auto"}}>
                        ...
                        <Row style={{ lineHeight: "1.5" }}>
                            <Link to={'/login'} style={{ color: "#fff" }}> <Col span={8} style={{ margin: "auto 0", fontSize: "20px"}}><UserOutlined /> </Col></Link>
